...
import com.components.input.model.AXInputType.DIGITS
 ...
 *
 * This composable extends the functionality of [AXInput] to create a text input field
...
/**
 * Example usage of the AXInputCurrency composable.
 */
@Composable
@Preview
private fun AXInputCurrencyPreview() {
    Column(

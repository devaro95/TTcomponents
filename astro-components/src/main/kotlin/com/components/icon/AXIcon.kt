...
/**
 * `AXIcon` is a composable function that displays an icon with customizable properties.
 *
...
fun AXIcon(
    ...
    onClick: (() -> Unit)? = null,
    tint: Color? = AXTheme.colorScheme.primaryColor,
) {
    Column(
